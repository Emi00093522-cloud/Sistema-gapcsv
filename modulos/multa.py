...
def mostrar_multas():
    ...
    try:
        ...
        # Filas para cada miembro ausente SIN justificación
        multas_a_registrar = []
        ...
        if miembros_ausentes:
            ...
            st.success("🎉 No hay miembros ausentes sin justificación. ¡No hay multas!")
