...
def mostrar_multas():
    ...
    try:
        ...
        if reglamento:
            ...
            dia_reunion = reglamento['dia_reunion']  # ← NUEVO
        else:
            monto_multa = 10.00
                ...
                try:
                    for multa in multas_a_registrar:
                        if multa["registrar"]:
                            ...
                            # 3. Insertar fecha límite de pago en Pago_Multa
                            fecha_limite = calcular_fecha_limite(dia_reunion)

                            cursor.execute("""
                                INSERT INTO Pago_Multa
        ...
        cursor.execute("""
            ...
            LEFT JOIN Pago_Multa pm ON pm.ID_Multa = mu.ID_Multa
