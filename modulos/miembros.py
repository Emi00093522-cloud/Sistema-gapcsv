...
def mostrar_miembro():  # ← CAMBIA el nombre de la función aquí
    ...
    try:
        ...
        cursor.execute("SELECT COUNT(*) as total FROM Miembro WHERE ID_Grupo = %s", (id_grupo,))  # ← Corregí "miembro" por "Miembro"
