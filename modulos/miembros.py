...
def mostrar_miembro():
    ...
    try:
        ...
        with st.form("form_miembro"):
            ...
            # Campo 7: telefono (opcional)
            telefono = st.text_input("Teléfono (opcional)", 
                                   placeholder="Ingrese el teléfono",
                                   max_chars=20)
            
            # Campo 8: ID_Rol (int, obligatorio) - Roles con IDs específicos
            st.write("**Rol en el grupo ***")
            ...
            # Mostrar primero los roles de directiva con un aviso especial
            ...
            # Mostrar información sobre el rol seleccionado
            ...
            # Campo 11: ausencias (int, opcional, default 0)
            ausencias = st.number_input("Ausencias (opcional)",
                                      min_value=0,
                                      value=0,
                                      step=1)
